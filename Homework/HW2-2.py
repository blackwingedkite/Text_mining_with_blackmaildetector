...
print(x_training)
print(type(x_training)) #<class 'scipy.sparse._csr.csr_matrix'>
print(x_training.shape) #(195, 19130)
...
print(type(x_train)) # <class 'scipy.sparse._csr.csr_matrix'>(175, 19130)
print(type(y_train)) # <class 'list'>，打亂的175個東西 label
print(type(x_test)) # <class 'scipy.sparse._csr.csr_matrix'>20, 19130)
print(type(y_test)) # <class 'list'> 剩下的20個 label
...
# plt.savefig('linear kernal curve.svg')
...
# # 寫入CSV檔案
# with open('linear_kernal.csv', 'w', newline='') as csvfile:
#   # 以空白分隔欄位，建立 CSV 檔寫入器
